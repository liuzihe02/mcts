...
This is a minimal implementation of Monte Carlo Tree Search (MCTS) for 2 player games. This repo is heavily inspired by [int8's repo](https://github.com/int8/monte-carlo-tree-search) and [qpwo's repo](https://gist.github.com/qpwo/c538c6f73727e254fdc7fab81024f6e1), and captures elements from both.
...
We borrow notes and figures from [int8's website](https://int8.io/monte-carlo-tree-search-beginners-guide/) and the [MCTS Wikipedia page](https://en.wikipedia.org/wiki/Monte_Carlo_tree_search).
